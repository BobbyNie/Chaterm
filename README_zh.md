...
| 日期 | 上游版本 | 主要更新 | 状态 |
|------|----------|----------|------|
| 2026-03-24 | 0.9.4 | K8s 集成、Skills 增强、终端改进、Bug 修复 | ✅ 已同步 |
| 2026-03-17 | 0.9.3 | 初始内网版 Fork、CI/CD 设置、功能移除 | ✅ 完成 |

**最新同步详情 (2026-03-24)：**
- 合并上游 151 个提交
- 新增 K8s 集成功能（741 行代码）
- 新增 Skills 增强（阶段聊天附件）
- 修复 IndexedDB、文件操作、Shell 处理
- 更新依赖项（xterm.js 6.0、AWS SDK、openai 6.32.0）
- 所有 129 个内网版测试通过
- 总测试覆盖：2536+ 个测试
