...
describe('markdownRenderer kb search results', () => {
  ...
  it('does not copy when Ctrl+C without selection', async () => {
    const wrapper = mount(MarkdownRenderer, {
      ...globalMountOptions,
      attachTo: document.body,
      props: {
  ...
  it('does not copy on plain C key without modifier', async () => {
    const wrapper = mount(MarkdownRenderer, {
      ...globalMountOptions,
      attachTo: document.body,
      props: {
  ...
  it('handles clipboard write failure gracefully', async () => {
    clipboardWriteText.mockRejectedValueOnce(new DOMException('Permission denied', 'NotAllowedError'))
